...
namespace CalvaJ_ExamenP1.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(CalvaJ_ExamenP1DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,Correo,Telefono,IngresoMensual,EsMayorEdad,FechaRegistro")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,Correo,Telefono,IngresoMensual,EsMayorEdad,FechaRegistro")] Propietario propietario)
        {
